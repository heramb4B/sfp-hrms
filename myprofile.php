...
<html>
<head>
  <title>My Profile | Employee Panel | HRMS | SFP </title>
  <!-- Icons font CSS-->
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="myprofileup.php?id=<?php echo $id?>" >
                        ...
                        <div class="input-group">
                          <p>Aadhar</p>
                            <input class="input--style-1" type="number" name="aadhar" value="<?php echo $aadhar;?>" readonly>
                        </div>

                        <div class="input-group">
                          <p>Employee Id</p>
                            <input class="input--style-1" type="number" name="employee_id" value="<?php echo $employee_id;?>" readonly>
                        </div>

                        <div class="input-group">
                          <p>PAN</p>
                            <input class="input--style-1" type="number" name="pan" value="<?php echo $pan;?>" readonly>
                        </div>
                        ...
                        <!-- <div class="p-t-20">
                            <button class="btn btn--radius btn--green"  name="send" style="background-color: #187bcd">Update Info</button>
                        </div> -->
