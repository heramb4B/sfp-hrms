...
<head>
    ...
    <!-- Title Page-->
    <title>Admin Panel | HRMS | Admin </title>
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" minlength="10" maxlength="10" placeholder="Contact Number" name="contact" required="required" >
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="number" minlength="16" maxlength="16" placeholder="aadhar" name="aadhar" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="employee_id" name="employee_id" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="pan" name="pan" required="required">
                        </div>
